...
INPUT_DIR = 'data/prolific.pilot100b.annotations'
        ...
        if "annotated_instances.jsonl" in files:
            ...
            with open(file_path, 'r') as file:
                for line in file:
                    ...
                    relevance_obj = json_object['label_annotations'].get('relevance')
                    stance_obj = json_object['label_annotations'].get('stance')
